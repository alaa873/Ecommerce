...
export const getCategories = createAsyncThunk("category/getcategories", async (limit, thunkAPI) => {
    try {
...
export const getCategoryPagination = createAsyncThunk("category/getCategoryPagination", async (page, thunkAPI) => {
    try {
...
const initialState = { category: [], isLoading: false, error: null }
